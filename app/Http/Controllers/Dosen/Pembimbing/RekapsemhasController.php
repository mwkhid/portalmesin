...
class RekapsemhasController extends Controller
{
    /**
    ...
    public function show($id)
    {
        ...
        $pdf = PDF::loadview('dosen.semhas.nilai.cetak',compact('data','nilai1','nilai2','nilai3','nilai4','rata2',
    ...
    public function edit($id)
    {
        ...
        $pembimbing2 = Nilaisemhaspembimbing::where('ta_pembimbing_id',$pembimbing->id)->first();
        ...
        // dd($semhas);
        return view('dosen.semhas.nilai.rekap',compact('data','nilai','pembimbing2','penguji1','penguji2','rata2','pembimbing','uji1','uji2','semhas'));
    }
