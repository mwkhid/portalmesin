...
@include('admin.semhas.list.doc.undangan')
<div class="page-break"></div>
@include('admin.semhas.list.doc.berita_acara')
<div class="page-break"></div>
@include('admin.semhas.list.doc.rekap')
<div class="page-break"></div>
@include('admin.semhas.list.doc.penilaian1')
<div class="page-break"></div>
@include('admin.semhas.list.doc.penilaian2')
<div class="page-break"></div>
@include('admin.semhas.list.doc.penilaian3')
<div class="page-break"></div>
@include('admin.semhas.list.doc.penilaian4')
<div class="page-break"></div>
@include('admin.semhas.list.doc.revisi1')
<div class="page-break"></div>
@include('admin.semhas.list.doc.revisi2')
<div class="page-break"></div>
@include('admin.semhas.list.doc.revisi3')
<div class="page-break"></div>
@include('admin.semhas.list.doc.revisi4')
<div class="page-break"></div>
@include('admin.semhas.list.doc.daftar_hadir')
<div class="page-break"></div>
@include('admin.semhas.list.doc.persetujuan')
</body>
</html>