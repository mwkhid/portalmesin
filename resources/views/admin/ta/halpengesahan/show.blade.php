        ...
        <div class="block-content block-content-full">
            <div class="row">
                <div class="col-md-2" align="center" style="padding: 6px 0;">
                    ...
                    <form action="{{route('admin.halpengesahan.update', $pengesahan->mahasiswa_id)}}" method="post">
                    @method('PATCH')
                    @csrf
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('admin.halpengesahan.index')}}" class="btn btn-secondary btn-noborder btn-rounded float-right">Kembali</a>
                </div>
            </div>
        </div>
    </div>
