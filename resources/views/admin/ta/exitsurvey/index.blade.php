...
<!-- Dynamic Table with Export Buttons -->
    ...
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Exit Survey Mahasiswa <small>Teknik Elektro</small></h3>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="font-size-sm text-center">
                        @if($row->statusExitsurvey($row->id))
                    ...
                    <td width="250" style="text-align: center;">
                        <a href="{{ route('admin.exitsurvey.show', $row->id)}}" class="btn btn-sm btn-alt-info btn-noborder btn-rounded mr-5 mb-5"><i class="fa fa-eye"></i> Details</a>
