...
@section('title','List Pendaftaran TA')
...
<!-- Dynamic Table with Export Buttons -->
    ...
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Daftar Pendaftaran TA <small>Teknik Elektro</small></h3>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="250" style="text-align: center;">
                        <a href="{{route('admin.pendaftaran.edit', $row->id)}}" class="btn btn-sm btn-alt-primary mr-5 mb-5"><i class="fa fa-eye"></i> Lihat</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
