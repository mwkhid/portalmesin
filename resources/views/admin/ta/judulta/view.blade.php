...
@section('content')
<div class="content">
    <form action="{{route('admin.perubahanjudul.update', $data->id)}}" method="post">
    @method('PATCH')
    @csrf
                    ...
                    <div class="row">
                        ...
                        @foreach($pembimbing as $pembimbings)
                            <div class="form-group">
                                ...
                                @if($pembimbings->status_perubahanjudul == 1)
                                    <button type="submit" name="action" class="btn btn-success" disabled>DISETUJUI</button>
                                @elseif($pembimbings->status_perubahanjudul == 0)
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="float-right ml-auto">
                                    ...
                                    <a href="{{route('admin.perubahanjudul.index')}}" class="btn btn-secondary mb-5">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div><br>
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <textarea type="text" class="form-control" id="judul" name="judul_lama" rows="4" readonly>{{$data->judul_lama}}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12" for="judul_baru">Judul baru</label>
                        <div class="col-md-12">
                            <textarea type="text" class="form-control" id="judul_baru" name="judul_baru" rows="4" readonly>{{$data->judul_baru}}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12" for="judul_alasan">Alasan Perubahan Judul</label>
                        <div class="col-md-12">
                            <textarea type="text" class="form-control" id="judul_alasan" name="judul_alasan" rows="4" readonly>{{$data->judul_alasan}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
