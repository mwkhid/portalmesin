...
@section('title','Report Balasan KP')
...
<!-- Dynamic Table with Export Buttons -->
    ...
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Daftar Report Balasan Kerja Praktek <small>Teknik Elektro</small></h3>
        </div>
        <div class="block-content block-content-full">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <a href="{{ route('admin.reportbalasan.show', $row->id)}}" class="btn btn-sm btn-alt-secondary mr-5 mb-5" target="_blank"><i class="fa fa-eye"></i> Lihat Surat Balasan</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
