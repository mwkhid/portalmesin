<div class="container">
    <div class="row">
       <div class="col">
            <p style="text-align: center; font-size: 16px; margin:2px; padding-bottom:2px;"><strong>Lembar Penilaian Sidang Pendadaran Skripsi</strong></p>
            <br>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <br>Penguji<br><br><br><br><br><strong>{{$pembimbing2->nama_dosen}}</strong> <br>NIP. {{$pembimbing2->nip}}</td>
                </tr>
            </table>
        </div>     
    </div>
