...
<!-- Dynamic Table with Export Buttons -->
    ...
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Daftar Pendaftaran TA Manufaktur<small> Teknik Mesin</small></h3>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="250" style="text-align: center;">
                        ...
                        <a href="{{route('admin.manufaktur.show', $row->id)}}" class="btn btn-sm btn-alt-primary mr-5 mb-5"><i class="fa fa-eye"></i> Lihat</a>
                        @else
                        <a href="{{route('admin.manufaktur.edit', $row->id)}}" class="btn btn-sm btn-alt-warning mr-5 mb-5"><i class="fa fa-edit"></i> Update</a>
                        @endif
                    </td>
                </tr>
                @endforeach
