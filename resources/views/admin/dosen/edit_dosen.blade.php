            ...
            <div class="col-md-8">
                ...
                <div class="block">
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <form action="{{ route('admin.dosen.update', $data->id) }}" method="post">
                        @method('PATCH')
                        @csrf
                            <div class="form-group">
                                <label for="kode dosen">Kode Dosen</label>
                                <input type="text" class="form-control" name="kode_dosen" value="{{ $data->kode_dosen}}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control js-select2" name="status_dosen" id="status_dosen" data-live-search="true">
                                    <option name="status_dosen" value="AKTIF" {{($data->status_dosen == 'AKTIF') ? 'selected' : ''}}>AKTIF</option>
                                    <option name="status_dosen" value="INAKTIF" {{($data->status_dosen == 'INAKTIF') ? 'selected' : ''}}>TIDAK AKTIF</option>
                                </select>
                                <div class="text-danger">{{ $errors->first('status_dosen')}}</div>
                                <!-- <input type="text" class="form-control" name="status_dosen" value="{{ $data->status_dosen}}"> -->
                            </div>
                            <div class="form-group">
