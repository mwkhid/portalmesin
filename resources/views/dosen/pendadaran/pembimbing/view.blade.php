            ...
            <div class="block">
                ...
                <form action="{{route('dosen.pembimbing_pendadaran.store')}}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="n1" placeholder="Nilai 0 - 100" value="{{old('n1')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="n2" placeholder="Nilai 0 - 100" value="{{old('n2')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="n3" placeholder="Nilai 0 - 100" value="{{old('n3')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="n4" placeholder="Nilai 0 - 100" value="{{old('n4')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="n5" placeholder="Nilai 0 - 100" value="{{old('n5')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="n6" placeholder="Nilai 0 - 100" value="{{old('n6')}}">
