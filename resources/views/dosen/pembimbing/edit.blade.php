...
<div class="content">
    ...
    @endif
    <form action="{{route('dosen.pembimbingta.updatelama', $data->id)}}" method="post">
    @method('PATCH')
    @csrf
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="block-content">
                    ...
                    <!-- <input type="text" name="id_baru" value="{{$data->pembimbing_baru}}" hidden>
                    <input type="text" name="id_lama" value="{{$data->pembimbing_lama}}" hidden> -->
                    <div class="row">
                        <div class="col-md-6">
                            @foreach($pembimbinglama as $key=>$pembimbinglamas)
                            <div class="form-group">
                                <input type="text" class="form-control" name="idpem_lama{{$key+1}}" value="{{$pembimbinglamas->pembimbing_lama}}" hidden>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <a href="{{route('dosen.pembimbingta.index')}}" class="btn btn-alt-secondary mb-5">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
