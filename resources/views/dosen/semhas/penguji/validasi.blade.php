    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="block-content">
                <form action="{{route('dosen.penguji_semhas.validasi', $nilai->id)}}" method="post">
                    @method('PATCH')
                    @csrf
                    <h5>Presentasi (30%)</h5>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-md-8">
                            ...
                            <a href="{{route('dosen.penguji_semhas.edit', $data->ta_id)}}" class="btn btn-warning mr-5 mb-5">Edit</a>
                            @endif
