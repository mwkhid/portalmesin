...
<!-- Dynamic Table with Export Buttons -->
    ...
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Daftar Mahasiswa Uji Seminar Hasil <small>Teknik Elektro</small></h3>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <a href="{{route('dosen.penguji_semhas.show', $row->ta_id)}}" class="btn btn-sm btn-alt-primary mr-5 mb-5"><i class="fa fa-eye"></i> Lihat</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
