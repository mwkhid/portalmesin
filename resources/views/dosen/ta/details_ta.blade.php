            ...
            <div class="block">
                ...
                <div class="block-content">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                        <a href="{{route('dosen.logbookta.details', $ta->nim)}}" class="btn btn-alt-primary mr-5 mb-5"><i class="fa fa-eye"></i> Log Book Tugas Akhir</a>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-12">
                            <a href="{{route('dosen.ta.index')}}" class="btn btn-secondary mr-5 mb-5 float-right">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
